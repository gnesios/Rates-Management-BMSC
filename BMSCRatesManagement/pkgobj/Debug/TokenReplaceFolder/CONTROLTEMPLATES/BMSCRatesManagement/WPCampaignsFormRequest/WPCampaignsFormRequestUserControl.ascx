...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WPCampaignsFormRequestUserControl.ascx.cs" Inherits="BMSCRatesManagement.WPCampaignsFormRequest.WPCampaignsFormRequestUserControl" %>
...
<div class="container">
    <div class="form-area">
        ...
        <div class="title">Formulario Campañas</div>
        <table class="form">
            <tr>
            ...
            <tr>
                <td class="icon"><span class="icon_campaign" title="Datos de la Campaña"></span></td>
                <td class="left">
                    <label>Campaña<br />
                        <asp:RequiredFieldValidator ID="rfvCampaign" runat="server"
                            Text="Datos incorrectos." InitialValue="" Display="Dynamic"
                            ControlToValidate="txbCampaign" ValidationGroup="Search" CssClass="errorMessage" />
                        <asp:RequiredFieldValidator ID="rfvListCampaigns" runat="server"
                            Text="Seleccione la campaña." InitialValue="" Display="Dynamic"
                            ControlToValidate="lsbCampaign" ValidationGroup="Show" CssClass="errorMessage" />
                        <asp:Label ID="lblCampaignSearch" runat="server" CssClass="errorMessage"></asp:Label>
                    </label>
                </td>
                <td class="right">
                    <asp:UpdatePanel ID="updCampaignSearch" UpdateMode="Conditional" runat="server" class="updatePanel">
                        <ContentTemplate>
                            <asp:TextBox runat="server" ID="txbCampaign" TabIndex="9" MaxLength="20" placeholder="Ingrese * para buscar todas"></asp:TextBox>
                            <asp:Button ID="btnCampaignSearch" runat="server" TabIndex="10" Text="Buscar Campaña"
                                OnClick="btnCampaignSearch_Click" ValidationGroup="Search" />
                            <asp:ListBox ID="lsbCampaign" runat="server" TabIndex="11" Rows="5" SelectionMode="Single"
                                Enabled="false"></asp:ListBox>
                            <asp:UpdateProgress ID="uppCampaignSearch" AssociatedUpdatePanelID="updCampaignSearch" runat="server">
        ...
        <div class="buttons-area">
            <asp:Button runat="server" ID="btnShowCampaign" TabIndex="12" Text="Mostrar Campaña"
                OnClick="btnShowCampaign_Click" ValidationGroup="Show" />
        </div>
    </div>
</div>
</asp:Panel>
...
<div class="container">
    <div class="form-area">
        ...
        <table class="print">
            ...
            <tr>
                <td colspan="2">
                    <asp:Literal ID="ltrCampaignImage" runat="server"></asp:Literal>
                </td>
            </tr>
        </table>
        <div class="buttons-area">
